...
const TOOL_NAMES =
  "createDocument|updateDocument|editDocument|requestSuggestions|saveGoal|savePlan|generateMealPlan|logWorkout|logMeal|logWater|logSleep|logWeighIn|updateProfile|getDashboard";
