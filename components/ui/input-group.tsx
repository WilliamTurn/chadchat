...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        // h-full: the group's size variant owns the control height, and the
        // inner input fills it so the whole construct is the tap target
        // (composition canon 03 #49: hit area >= 44px on touch surfaces).
