...
/**
 * The Quit Date on/off switch (FEAT-25, all members). Off hides the /today
    ...
    <div className="flex flex-wrap items-center justify-between gap-4">
      <div>
        ...
        <p className="mt-1 text-muted-foreground text-sm">
          Chad predicts the exact day you quit and keeps the countdown on your
          dashboard. Switch it off to hide the prediction everywhere and stop
          him bringing it up.
        </p>
      </div>
      <Switch
